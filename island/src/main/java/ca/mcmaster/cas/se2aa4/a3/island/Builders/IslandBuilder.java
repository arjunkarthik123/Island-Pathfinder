...
import ca.mcmaster.cas.se2aa4.a3.island.AdapterToPathFinder.CityBuilder;
...
public class IslandBuilder extends AbstractBuilder {
    ...
    @Override
    public void buildIsland(Mesh aMesh, Random rand, int numAquifers, int numLakes, int numRivers, int cities){
